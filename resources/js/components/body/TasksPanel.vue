  ...
  <div class="body-tasks-panel" :class="getTheme">
    <div class="topTaskDiv" :class="getTheme">
      ...
      <div class="searchElementsDiv" :class="getTheme">
        ...
        ></i>
        <i class="mdi mdi-sort-numeric searchIcons" :class="getTheme" @click="toggleTaskIdFilter"></i>
      </div>
    </div>
    ...
    <vue-context ref="menu" @open="onOpenContextMenu">
      <li>
        <a @click.prevent="onClickContextMenu('delete')">{{ t("Delete Task") }}</a>
      </li>
      <li>
        <a @click.prevent="onClickContextMenu('complete')">{{ t("Complete Task") }}</a>
      </li>
      <li>
        <a @click.prevent="onClickContextMenu('clone')">{{ t("Clone Task") }}</a>
      </li>
    </vue-context>
  </div>
</template>
