...
export default {
  ...
  locales: {
    ...
    bg_BG: {
      ...
      Tools: "Инструменти",
      "Show Tools Menu": "Покажи Настройки",
      Options: "Настройки",
      Help: "Помощ",
      About: "За Програмата",
      ...
      "Short description of the decision ...": "Описание на решението ...",
      "Documents attached to this task": "Документи прикачени към тази задача",
      ...
      "Choose User to add...": "Изберете потребител за добавяне към проекта",
